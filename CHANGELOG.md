...
### 보안
- Claude plugin successor 계보를 #1146까지 복구했습니다. #1141 catalog binding, #1142 SARIF receipt, #1143 license mismatch, #1144 package lifecycle download, #1145 dynamic-eval, #1146 hidden/undeclared executable을 각각 최신 parent 위로 ordinary two-parent merge했고, 모든 head가 current parent보다 0 behind입니다. Exact-tree Claude-plugin 회귀는 104/104 → 110/110 → 118/118 → 128/128 → 133/133 → 145/145를 통과했습니다. Hosted exact-head workflow와 독립 review가 없어 모두 Draft이며, #1150 이후는 아직 미승계 상태입니다.
