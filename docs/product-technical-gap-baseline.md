...
| G-06 | Resolve stateful regex FP/FN divergence structurally. | #1088/#1133/#1152; #1080; #1099 command-state owners | Still in progress. #1036 closes one bounded spelling-parity miss and #1157 removes one proven cross-namespace admission FP while retaining same-namespace duplicate positives; neither closes the structural-analysis Gap. Preserve historical rule IDs, reachability/state oracles and realistic performance evidence. |
