...
| Canonical central CodeQL owner #2040 and related #2051 | `.github#2040` comments `5644656829` and `5644947368` bind attempt 1 and the terminal-failure attempt-2 canary. Fresh owner head is Draft `be25a767aa2e0d5cb79d6988853011bae16d4be3` on `main@cb0872c9a20d5584703dffacca65c096fc034c6c`; its PR body still names predecessor `a9b18b4b...`, so that body state is stale. #2051 separately describes a proposed new-client base-ref title/bootstrap mismatch. | This consumer uses the protected old title form; terminal producer-job failure still does not prove the distinct #2051 mismatch. The owner head currently has no pull-request workflow run, no approval, and no unresolved inline thread on the observed generation. | Keep #2040 Draft until its body/evidence is current, mergeability is restored, exact-head hosted gates pass, and qualifying independent review exists. Then integrate normally, release an immutable contract, and validate consumers; no release is claimed. |
