...
| #1157, `feat/claude-plugin-conflicting-identity-1099` | Initial RED `6f0eb445ecc0d48dfafd2c3d2525eb7cc1e462f7`; namespace partition `ba38201644b9ffa75721e14eb56dc4f4c2c9ef5e`; concurrent test-only RED `d4d5df567963cd9d11f43c37e436263d07471bf7`; exact GREEN head `1b761e04f81f6b28eb9e541ce14802af6b5cc158`; production/test blobs `eee7787fa5cb4905893ea9b3d4d026239965467f` / `5881b775f03a110769047cf6268cceb803c129fc`; base `a6f6a742701c263efcd83402da1815e065d69706`; open/Draft, six ahead / zero behind. | One global set first erased plugin, Skill/legacy Command, and Agent namespaces. The refined boundary also derives a legacy Command identity from its filename/path and places it in the Skill namespace; inert frontmatter `name` does not mint a second identity. Plugin namespaces and Agents remain separate; same-effective-Skill duplicates remain findings. | Initial causal RED was 2 failed / 1 passed. Exact concurrent predecessor source/test blobs then exposed 2 failed / 13 passed: a missed Skill↔Command filename collision and a false collision between distinct command paths sharing frontmatter prose. Exact current blobs pass the focused module 15/15 and `py_compile`. This isolated harness stubs an unrelated scanner adapter; no full-suite or hosted result transfers. Custom-base PR has no hosted run, formal review, or thread; keep Draft pending parent integration, exact-head Checks, independent approval, protected merge, and release. |
...
Keep #1036 Ready for independent review on unchanged `832d066...`; do not merge while CodeQL and current-head approval are incomplete. Keep #1157 Draft on `1b761e04...` until its custom-base candidate receives hosted exact-head Checks, parent integration, and independent approval; do not transfer the isolated 15-test result as repository-wide evidence. Keep #104 Draft on unchanged `4d738ccc...`: its HTTP-readiness functional repair is GREEN, but cancelled positive-LSM evidence and absent qualifying approval prohibit integration or release. Keep the central CodeQL canary at #2040 and the runner/workflow/queue handoff at #1590/#2083/#712 rather than starting competing owners or adding no-op triggers. Continue another safely owned reproducible corpus obligation while central work proceeds.
