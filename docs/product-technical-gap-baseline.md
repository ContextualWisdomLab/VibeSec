...
## Security-defect corpus — live 2026-09-07 05:13 UTC snapshot
...
10. Keep #998 Draft at `948c5f8` until current-head gates, including dedicated Python shell AST coverage and admission, are terminal-success. 15 SUCCESS checks at 05:13 UTC are not merge authority. Robot reviews are not GitHub `APPROVE`. Do not Close #983 from this snapshot.
