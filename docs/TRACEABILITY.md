...
| Claude plugin marketplace/package supply chain (#1099) | `claude-plugin-floating-git-ref`, `claude-plugin-provider-secret`, `claude-plugin-pipe-to-shell`, `claude-plugin-undeclared-executable`, `claude-plugin-symlink-escape`, deterministic scan receipt | implemented-branch |
